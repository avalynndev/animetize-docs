...
```
https://animetize-api.vercel.app/anime/gogoanime/watch/{episodeId}?server={serverName}
```
...
<Tabs items={["JavaScript", "Python"]}>
  <Tab>
    <>
        ...
        */
        const url = "https://animetize-api.vercel.app/anime/gogoanime/watch/spy-x-family-episode-1";
        const data = async () => {
            try {
  ...
  <Tab>
    <>
        ...
        explicitly defining default server for demostrative purposes.
        """
        url = "https://animetize-api.vercel.app/anime/gogoanime/watch/spy-x-family-episode-1"
