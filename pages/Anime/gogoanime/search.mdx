...
```
https://https://animetize-api.vercel.app//anime/gogoanime/{query}?page={number}
```
...
<Tabs items={["JavaScript", "Python"]}>
  <Tab>
    <>
        ...
        const url = "https://https://animetize-api.vercel.app//anime/gogoanime/demon?page=2";
        const data = async () => {
            try {
  ...
  <Tab>
    <>
        ...
        # Using the example query "demon", and looking at the 2nd page of results.
        url = "https://https://animetize-api.vercel.app//anime/gogoanime/demon"
