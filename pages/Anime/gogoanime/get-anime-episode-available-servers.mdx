...
```
https://https://animetize-api.vercel.app//anime/gogoanime/servers/{episodeId}
```
...
<Tabs items={["JavaScript", "Python"]}>
  <Tab>
    <>
        ...
        const url = "https://https://animetize-api.vercel.app//anime/gogoanime/servers/spy-x-family-episode-1";
        const data = async () => {
            try {
  ...
  <Tab>
    <>
        ...
        # Using the example episode ID of 'spy-x-family-episode-1'.
        url = "https://https://animetize-api.vercel.app//anime/gogoanime/servers/spy-x-family-episode-1"
