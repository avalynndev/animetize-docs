...
```
https://https://animetize-api.vercel.app//anime/gogoanime/recent-episodes
```
...
<Tabs items={["JavaScript", "Python"]}>
  <Tab>
    <>
        ...
        const url = "https://https://animetize-api.vercel.app//anime/gogoanime/recent-episodes";
        const data = async () => {
            try {
  ...
  <Tab>
    <>
        ...
        url = "https://https://animetize-api.vercel.app//anime/gogoanime/recent-episodes"
