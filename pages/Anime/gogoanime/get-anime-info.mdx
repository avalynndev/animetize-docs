...
```
https://https://animetize-api.vercel.app//anime/gogoanime/info/{id}
```
...
<Tabs items={["JavaScript", "Python"]}>
  <Tab>
    <>
        ...
        const url = "https://https://animetize-api.vercel.app//anime/gogoanime/info/spy-x-family";
        const data = async () => {
            try {
  ...
  <Tab>
    <>
        ...
        # Using the example ID of "spy-x-family".
        url = "https://https://animetize-api.vercel.app//anime/gogoanime/info/spy-x-family"
