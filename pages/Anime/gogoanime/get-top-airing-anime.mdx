...
```
https://https://animetize-api.vercel.app//anime/gogoanime/top-airing
```
...
<Tabs items={["JavaScript", "Python"]}>
  <Tab>
    <>
        ...
        const url = "https://https://animetize-api.vercel.app//anime/gogoanime/top-airing";
        const data = async () => {
            try {
  ...
  <Tab>
    <>
        ...
        url = "https://https://animetize-api.vercel.app//anime/gogoanime/top-airing"
